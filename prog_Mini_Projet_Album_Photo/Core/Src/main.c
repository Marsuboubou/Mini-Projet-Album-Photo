 ...
 ******************************************************************************
 * @file           : main.c
 * @brief          : Main du Projet Album Photo
 ******************************************************************************
 * @attention
 *
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, LED13_Pin|GPIO_PIN_12|LED11_Pin|LED12_Pin
  ...
  /*Configure GPIO pins : LED13_Pin PH12 LED11_Pin LED12_Pin
                           LED2_Pin LED18_Pin */
  GPIO_InitStruct.Pin = LED13_Pin|GPIO_PIN_12|LED11_Pin|LED12_Pin
                          |LED2_Pin|LED18_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void StartDefaultTask(void const * argument)
{
  /* USER CODE BEGIN 5 */
	...
	uint8_t wtext[30] = "Hello world SD ! :-)"; /* File write buffer */
			...
			if (f_mkfs((TCHAR const*) SDPath, FM_ANY, 0, workBuffer,
				...
				FA_CREATE_ALWAYS | FA_WRITE) != FR_OK) {
					...
					if ((byteswritten == 0) || (res != FR_OK)) {
						...
						if (f_open(&SDFile, "ST32.TXT", FA_READ) != FR_OK) {
...
void Error_Handler(void)
{
  /* USER CODE BEGIN Error_Handler_Debug */
	...
	while (1) {
		sprintf(text, "ERREUR");
		BSP_LCD_DisplayStringAtLine(15, (uint8_t*) text);
	}
