 ...
 ******************************************************************************
 * @file           : main.c
 * @brief          : Programme pour le mini projet sur la création d'un Album
 * à partir des photos présentent sur une carte SD
 *
 ******************************************************************************
 * @attention
 *
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	sprintf(text, "Bonjour Alonso, Lucien et Camilo");
...
void StartDefaultTask(void const * argument)
{
  /* USER CODE BEGIN 5 */
	...
	FRESULT res; /* FatFs function common result code */
		...
		uint8_t wtext[] = "Hello, tout fonctionne bien ! :-)"; /* File write buffer */
